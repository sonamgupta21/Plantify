...
const Header = () => {
  ...
  return (
    <header className="fixed z-50 w-screen p-3 md:p-4 px-4 md:px-16 bg-primary">
      {/* desktop &tablet */}
      <div className="hidden md:flex w-full h-full items-center justify-between">
        <Link className="flex items-center gap-2" to={"/"}>
          <img src={logo} className="w-8 object-cover" alt="logo" />

          <p className="text-headingColor text-2xl font-bold ml-2">Plantify</p>
        </Link>
        ...
        <motion.ul className="flex items-center gap-12">
          ...
          <li className="text-base text-textColor hover:text-green-800 hover:font-bold duration-100 transition-all ease-in-out cursor-pointer ">
            <AnchorLink href="#ourPlants">Our Plants</AnchorLink>
          </li>
          <li className="text-base text-textColor hover:text-green-800 hover:font-bold duration-100 transition-all ease-in-out cursor-pointer ">
